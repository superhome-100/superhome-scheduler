...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$stateLoaded && $loginState === "in" ? `<div class="[&>*]:mx-auto flex items-center justify-between"><div class="dropdown h-8 mb-4"><label tabindex="0" class="border border-gray-200 dark:border-gray-700 btn btn-fsh-dropdown">Classroom</label>
	...
	<br>
	<div class="flex justify-between"><a class="inline-flex items-center border border-solid border-transparent hover:border-black rounded-lg pl-1.5 pr-4 py-0 hover:text-white hover:bg-gray-700" href="/multi-day/classroom"><span>${validate_component(Chevron, "Chevron").$$render($$result, { direction: "left" }, {}, {})}</span>
...
//# sourceMappingURL=_page.svelte-246a283d.js.map
