...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="tab-content translations-content-item en visible" id="en"><h1>Privacy Policy</h1>
	...
	<ul><li><p><strong>Account</strong> means a unique account created for You to access our Service or parts
		...
		<li><p><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common
		...
		<li><p><strong>Website</strong> refers to SuperHOME Scheduler, accessible from
				<a href="superhome-scheduler-vercel.app" rel="external nofollow noopener" target="_blank">superhome-scheduler-vercel.app</a></p></li>
	...
	<ul><li><p>First name and last name</p></li>
	...
	<h3 class="text-xl font-medium mt-4 mb-2">Delete Your Personal Data</h3>
	<p class="mb-4">You have the right to delete or request that We assist in deleting the Personal Data that We
		have collected about You.
	</p>
	<p class="mb-4">Our Service may give You the ability to delete certain information about You from within the
		Service. You may contact Us through <a href="https://www.facebook.com/freedivesuperhome2024/" rel="external nofollow noopener" target="_blank">https://www.facebook.com/freedivesuperhome2024/</a> to request access to, correct, or delete any personal information that You have provided to Us.
	</p>
	<p class="mb-4">Please note, however, that We may need to retain certain information when we have a legal
		obligation or lawful basis to do so.
	</p>
	...
	<ul><li>By visiting this page on our website: <a href="https://www.facebook.com/freedivesuperhome2024/" rel="external nofollow noopener" target="_blank">https://www.facebook.com/freedivesuperhome2024/</a></li></ul></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-5b125d88.js.map
