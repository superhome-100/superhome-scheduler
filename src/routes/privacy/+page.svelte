<div class="tab-content translations-content-item en visible" id="en">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to SuperHOME Scheduler, accessible from
				<a href="superhome-scheduler-vercel.app" rel="external nofollow noopener" target="_blank"
					>superhome-scheduler-vercel.app</a
				>
			</p>
		</li>
		<li>
