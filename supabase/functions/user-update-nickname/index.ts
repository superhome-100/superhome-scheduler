// Supabase Edge Function: user-update-nickname
// - Admin-only update of user_profiles.nickname
// - Uses shared CORS helpers
...
Deno.serve(async (req: Request) => {
  try {
    ...
    if (!body?.uid || body.nickname === undefined || body.nickname === null) {
