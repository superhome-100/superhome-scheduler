-- Create a function to get monthly reservation stats for the calendar
-- This allows non-admins to see availability/occupancy without seeing user details
...
LANGUAGE plpgsql
SECURITY DEFINER -- Runs with privileges of the creator (service role) to access all reservations
AS $$
BEGIN
  RETURN QUERY
