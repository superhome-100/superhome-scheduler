...
<div class="card bg-base-100 shadow-sm border border-base-300 rounded-xl p-6 mb-8">
  <div class="header-row flex justify-between items-center mb-8 px-2 flex-nowrap w-full">
    <h2 class="header-title flex-1 min-w-0 text-base sm:text-2xl font-semibold text-[#00294C] flex items-center gap-2 sm:gap-6 whitespace-nowrap">
      <span class="truncate max-w-[50vw] sm:max-w-none">User Management</span>
      <div class="badge badge-outline gap-2 px-2 py-1 text-xs sm:px-4 sm:py-2 sm:text-sm shrink-0">
    ...
    <button class="btn btn-ghost btn-xs sm:btn-sm gap-2 text-base-content/70 hover:text-base-content px-2 sm:px-3 py-1 whitespace-nowrap shrink-0" on:click={handleRefresh}>
